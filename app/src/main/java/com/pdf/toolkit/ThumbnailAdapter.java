...
public class ThumbnailAdapter extends RecyclerView.Adapter<ThumbnailAdapter.ViewHolder> {
    ...
    private final ArrayList<String> imagePaths; // Now uses paths
    ...
    public ThumbnailAdapter(ArrayList<String> imagePaths, OnThumbnailListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if(imgFile.exists()){
            holder.thumbnailImage.setImageURI(Uri.fromFile(imgFile));
        }
    }
